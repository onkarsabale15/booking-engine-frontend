    ...
    fetch(NEXT_PUBLIC_BACKEND_URL + `/api/property/${id}`)
     ...
     .then((data) => {
      console.log("This is Data : ",data.data)
       ...
       setHotel(data.data.configurations.stay[0])
      })
  }, []);
  return (
    <>
      ...
      {property && <GalleryTwo hotel={hotel} property={property} /> }
            ...
            <div className="col-xl-8">
              <div className="row y-gap-40">
                {/* <div className="col-12">
                  ...
                  {facilities &&  <PropertyHighlights highlightsContent={facilities} />}
                </div> */}
                ...
                <div className="col-12">
                  ...
                  <div className="row y-gap-10 pt-20">
                    {facilities &&  <PopularFacilities hotel={facilities} />}
                  </div> */}
                </div>
